...
PUMA_CONFIG_FILE=/var/www/resume/current/config/puma.rb
PUMA_PID_FILE=/var/www/resume/shared/tmp/pids/puma.pid
PUMA_SOCKET=/var/www/resume/shared/tmp/sockets/puma.sock
